...
struct ResultsView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .onAppear() {
                let weightDouble = Double(maxWeight) ?? 0.0
                let repsDouble = Double(repetitions) ?? 0.0
                user1RM = viewModel.getUser1RM(weight: weightDouble, repetitions: repsDouble)
            }
        }
...
struct ResultsView_Previews: PreviewProvider {
    static var previews: some View {
        ResultsView(maxWeight: "70", repetitions: "4")
    }
}
